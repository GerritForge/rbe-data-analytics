    ...
    for change in changes[:50]:
        ...
        for revision_number in range(1, total_revisions + 1):
            ...
            if checks_json_data:
                ...
                gcp_time_difference_seconds = calculate_time_difference(rbe_gcp_start, rbe_gcp_end)
                bb_time_difference_seconds = calculate_time_difference(rbe_bb_start, rbe_bb_end)
